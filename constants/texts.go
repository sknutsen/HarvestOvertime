...
const SaveDetailsButtonText string = "Save details"
const SettingsTabText string = "Settings"
const TaskSetupTabText string = "Task setup"
const TitleText string = "Get overtime hours"
